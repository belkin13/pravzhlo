(function ($, Drupal, drupalSettings) {
  ...
  jQuery(document).ready(function ($) {
    ...
    var sync1 = $(".block-views-blockmain-slider-block-1 .view-content").first();// This is the ID of the block with the single item/big image. It's possible to use ID's of multiple slideshows, separated by a comma <- Make sure this is the ID of the div that also has the class "owl-carousel"
